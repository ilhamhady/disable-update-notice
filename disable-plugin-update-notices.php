...
if (!class_exists('Disable_Update_Notices')) {
    ...
    class Disable_Update_Notices
    {
        ...
        public function admin_page_content()
        {
            ...
            <div class="wrap">
                <h1>
                    <?php esc_html_e('Disable Update Notices', 'disable-update-notices'); ?>
                </h1>
                <h2 class="nav-tab-wrapper">
                    <a href="?page=disable-update-notices&tab=plugins"
                        class="nav-tab <?php echo $this->active_tab == 'plugins' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Plugin Updates', 'disable-update-notices'); ?></a>
                    <a href="?page=disable-update-notices&tab=themes"
                        class="nav-tab <?php echo $this->active_tab == 'themes' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Theme Updates', 'disable-update-notices'); ?></a>
                    <a href="?page=disable-update-notices&tab=wordpress"
                        class="nav-tab <?php echo $this->active_tab == 'wordpress' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('WordPress Updates', 'disable-update-notices'); ?></a>
                </h2>
